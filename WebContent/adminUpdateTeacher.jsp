...
<body>
	<div id="login_frame">
		<br>
		<p id="image_logo">教师信息修改</p>
		<%-- <font color=red>${message}</font> --%>

		<form action="adminUpdateTeacher.do" method="post">
			...
			<p>
				<label class="label_input">修改电话</label><input type="text"
			...
			<br>
			<p>
				<a href="adminDisplayAddTeacher.do">查看教师信息修改情况>>></a>
			</p>
