...
<body>
	<div id="login_frame">
		<br>
		<p id="image_logo">课程信息修改</p>
		<%-- <font color=red>${message}</font> --%>

		<form action="adminUpdateClass.do" method="post">
			...
			<p>
				<label class="label_input">修改授课教师</label><input type="text"
					name="yql_Tname14" id="yql_Tname14" class="text_field" />
			</p>
			<p>
				<label class="label_input">修改学时</label><input type="text"
					name="yql_Classhour14" id="yql_Classhour14" class="text_field" />
			</p>
			<p>
				<label class="label_input">修改考查方式</label><input type="text"
			...
			<br>
			<p>
				<a href="adminDisplayAddClass.do">查看课程信息修改情况>>></a>
			</p>
