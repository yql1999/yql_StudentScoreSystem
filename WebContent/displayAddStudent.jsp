...
<body>
	...
	<table class="hovertable">
		<tr>
			<th colspan="5"
				style="text-align: center; font-size: 20px; color: blue;">学生所有成绩查询结果表</th>
		</tr>
		<tr>
			<th>学号</th>
			<th>课程号</th>
		...
		<tr onmouseover="this.style.backgroundColor='#ffff66';"
			...
			<td><%=teacher.getYql_Sno14()%></td>
			<td><%=teacher.getYql_Cno14()%></td>
			<td><%=teacher.getYql_Startterm14()%></td>
			<td><%=teacher.getYql_Score14()%></td>
			<td><%=teacher.getYql_Tname14()%></td>
		</tr>
		<%
			}
		%>
