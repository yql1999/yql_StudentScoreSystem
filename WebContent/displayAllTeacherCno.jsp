...
<body>
	...
	<table class="hovertable">
		<tr>
			<th colspan="6"
				style="text-align: center; font-size: 20px; color: blue;">教师授课信息查询结果表</th>
		</tr>
		<tr>
			<th>教师编号</th>
			<th>教师名称</th>
		...
		<%
			ArrayList<Student> stuList = (ArrayList<Student>) session.getAttribute("student");
			for (Student student : stuList) {
		%>
		<tr onmouseover="this.style.backgroundColor='#ffff66';"
			onmouseout="this.style.backgroundColor='#d4e3e5';">
			<td><%=student.getYql_Tno14()%></td>
			<td><%=student.getYql_Tname14()%></td>
			<td><%=student.getYql_Cno14()%></td>
			<td><%=student.getYql_Cname14()%></td>
			<td><%=student.getYql_Credit14()%></td>
			<td><%=student.getYql_Classhour14()%></td>
		</tr>
		<%
			}
		%>
